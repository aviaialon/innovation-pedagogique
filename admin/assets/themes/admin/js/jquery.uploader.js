...
qq.extend(qq.UploadHandlerForm.prototype, {
    ...
    _upload: function(id){
        ...
        if (!input){
            throw new Error(SYSTEM.APPLICATION.UPLOADER.translate(
...
qq.FineUploaderBasic = function(o){
    ...
    this._options = {
        ...
        messages: {
            typeError: SYSTEM.APPLICATION.UPLOADER.translate(
            ...
            noFilesError: SYSTEM.APPLICATION.UPLOADER.translate(
                "No files to upload.",
                "Aucun de fichiers à telecharger."
            ),
            onLeave: SYSTEM.APPLICATION.UPLOADER.translate(
...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        text: {
            uploadButton: SYSTEM.APPLICATION.UPLOADER.translate(
                'Upload a file',
                'téléchargez un fichier'
            ),
            cancelButton: SYSTEM.APPLICATION.UPLOADER.translate(
                'Cancel',
                'Annuler'
            ),
            retryButton: SYSTEM.APPLICATION.UPLOADER.translate(
                'Retry',
                'Essayer a nouveau'
            ),
            failUpload: SYSTEM.APPLICATION.UPLOADER.translate(
                'Upload failed',
                'échec du téléchargement'
            ),
            dragZone: SYSTEM.APPLICATION.UPLOADER.translate(
                'Drop files here to upload',
                'Déposer des fichiers ici pour télécharger'
            ),
            dropProcessing: SYSTEM.APPLICATION.UPLOADER.translate(
                'Processing dropped files...',
                'Traitement des fichiers déposés ...'
            ),
            formatProgress: SYSTEM.APPLICATION.UPLOADER.translate(
                "{percent}% of {total_size}",
                "{percent}% de {total_size}"
            ),
            waitingForResponse: SYSTEM.APPLICATION.UPLOADER.translate(
                "Processing...",
                "Traitement..."
            )
        },
...
SYSTEM.APPLICATION.UPLOADER =
{
    ...
    initialise: function(configObject)
    {
        ...
        {
            SYSTEM.APPLICATION.UPLOADER.fileLimit = Number(configObject.fileLimit);
    ...
    translate: function(strEngVal, strFrVal)
    {
        ...
        var strlang     = ((SYSTEM.APPLICATION.UPLOADER.lang) || ('en'));
