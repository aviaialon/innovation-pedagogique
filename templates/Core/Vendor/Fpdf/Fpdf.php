...
{
	/**
     * Returns an instance of FPDF
     *
     * @access public
     * @throws \Exception
     * @return \Core\Net\Fpdf\FPDF
     */
    public static final function getInstance($orientation='P', $unit='mm', $size='A4')
    {
        return new \Core\Vendor\Fpdf\FPDF($orientation,  $unit, $size);
    }
}
