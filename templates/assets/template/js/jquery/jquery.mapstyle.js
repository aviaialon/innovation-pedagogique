...
if (typeof Object.create !== "function") {function C() {}
    ...
    var p = {
        ...
        createMap: function () {
            ...
            __map = this.map = new google.maps.Map(this.container[0], a);
			if (document.getElementById('slider-map-zoom-in'))  {
				google.maps.event.addDomListener(document.getElementById('slider-map-zoom-in'), 'click', function() {
					__map.setZoom(__map.getZoom() + 1);
				});	
			}
			if (document.getElementById('slider-map-zoom-out'))  {
				google.maps.event.addDomListener(document.getElementById('slider-map-zoom-out'), 'click', function() {
					__map.setZoom(__map.getZoom() - 1);
				});
			}
			sliderMap = this.map;
